...
import gin
from film_efficientnet import film_conditioning_layer
...
class EfficientNetEncoder(tf.keras.layers.Layer):
  ...
  def __init__(self,
               ...
               backbone_dropout_rate: float = dropout_settings.BACKBONE_SPATIAL_DROPOUT,
               **kwargs):
    ...
    Args:
      ...
      backbone_dropout_rate: Dropout rate to add after key convolutional blocks
